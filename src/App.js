  ...
  componentDidMount() {
    Promise.all([
      d3.csv("/data/breed_info.csv", d => ({
        ...
        weight: [Number(d["weight_low_lbs"]), Number(d["weight_high_lbs"])]
      })),
      ...
      const data = d3
        ...
        .reduce(
          (data, { key, values }) => ({
            ...data,
            [key]: values.reduce((obj, entry) => ({ ...obj, ...entry }), {})
          }),
          {}
        );
      ...
      <div className="App">
        ...
        {data !== null ? (
          <DashboardContext.Provider value={this.state}>
            <Descriptor />
            <svg style={{ width: "100%", height: 1024 }} ref={this.svgRef}>
              <Flexbox
                style={{
                  flexDirection: "row",
              ...
              >
                <Scatterplot
                  ...
                  height={200}
                  filter={d =>
                    d.weight && d.height && d.weight[0] && d.height[0]
                  }
                  xData={d => d.weight[0]}
                  yData={d => d.height[0]}
                  xLabel="Weight (lbs)"
                ...
                <Scatterplot
                  ...
                  width={400}
                  height={300}
                  filter={d => d.weight && d.sales && d.weight[0] && d.height}
                  xData={d => d.height[0]}
                  yData={d => d.sales}
                  xLabel="Height (in)"
                  yLabel="Sales"
